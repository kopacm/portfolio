...
4. Create all queries in SQL 
	- see Dashboard_1_orders_query,[Dashboard_2_stock_query1](https://github.com/kopacm/portfolio/blob/main/Pizza_Portfolio_Project/Dashboard_2_stock_query1.txt),... in folder
